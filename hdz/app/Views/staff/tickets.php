    ...
    <div class="card-body">
        ...
        <div class="form-group">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="1" id="overdueTickets" name="overdue" <?php echo ($request->getGet('overdue') == '1' ? 'checked' : ''); ?> <label class="form-check-label" for="overdueTickets">
