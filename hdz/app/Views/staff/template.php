...
<head>
    ...
    echo link_tag('https://getbootstrap.com/docs/5.3/assets/img/favicons/favicon.ico' . $par_time, 'icon', 'image/x-icon');
    echo link_tag('assets/components/fontawesome/css/all.min.css' . $par_time);
    echo link_tag('assets/components/bootstrap/css/bootstrap.min.css' . $par_time);
    echo link_tag('assets/admin/styles/shards-dashboards.1.1.0.css' . $par_time);
    echo link_tag('assets/components/daterangepicker/daterangepicker.css' . $par_time);
    echo link_tag('assets/components/sweetalert/sweetalert2.min.css' . $par_time);
    echo link_tag('assets/helpdeskz/css/staff.css' . $par_time);
    ?>
</head>
...
<body class="h-100">
        ...
        <div class="row">
            ...
            <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
                    ...
                    <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
                        <a class="navbar-brand w-100 mr-0" href="<?php echo site_url(route_to('staff_tickets')); ?>" style="line-height: 25px;">
                            <div class="d-table m-auto">
                                ...
                                <img id="main-logo" class="d-inline-block align-top mr-1 img-fluid" style="max-width: 50px;" src="<?php echo base_url('assets/helpdeskz/images/bootstrap-logo-shadow.png'); ?>">
                            </div>
                        </a>
                ...
                <div class="input-group input-group-seamless ml-3">
                    ...
                    <input name="keyword" class="navbar-search form-control" type="text" placeholder="<?php echo lang('Admin.form.searchTicket'); ?>..." aria-label="Search">
                </div>
                <?php
                echo form_close();
                ?>
            ...
            <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
                <div class="main-navbar sticky-top bg-white">
                    ...
                    <nav class="navbar align-items-stretch navbar-light flex-md-nowrap p-0">
                        ...
                        <div class="input-group input-group-seamless ml-3">
                            ...
                            <input class="navbar-search form-control" name="keyword" type="text" placeholder="<?php echo lang('Admin.form.searchTicket'); ?>..." aria-label="Search">
                        </div>
                        <?php
                        echo form_close();
                        ?>
                ...
                <footer class="main-footer d-flex mt-3 p-2 px-3 bg-white border-top">
                    <span class="copyright ml-auto my-auto mr-2">Copyright © 2015 - <?php echo date('Y'); ?>
                        <a href="https://hofarismail.site" rel="nofollow">HelpDeskZ v<?php echo HDZ_VERSION; ?></a>
                    </span>
                </footer>
            </main>
        </div>
    ...
    <?php
    echo script_tag('assets/components/jquery/jquery.min.js' . $par_time);
    echo script_tag('assets/components/bootstrap/js/bootstrap.bundle.min.js' . $par_time);
    ?>
    <!-- <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-HwwvtgBNo3bZJJLYd8oVXjrBZt8cqVSpeBNS5n7C8IVInixGAoxmnlMuBnhbgrkm" crossorigin="anonymous"></script> -->
    <?php
    echo script_tag('assets/admin/scripts/shards.min.js' . $par_time);
    echo script_tag('assets/admin/scripts/shards-dashboards.1.1.0.js' . $par_time);
    echo script_tag('assets/components/daterangepicker/moment.min.js' . $par_time);
    echo script_tag('assets/components/daterangepicker/daterangepicker.js' . $par_time);
    echo script_tag('assets/components/sweetalert/sweetalert2.all.min.js' . $par_time);
    echo script_tag('assets/components/blockui/jquery.blockUI.js' . $par_time);
    echo script_tag('assets/components/bs-custom-file-input/bs-custom-file-input-min.js' . $par_time);
    echo script_tag('assets/helpdeskz/js/staff.js' . $par_time);
